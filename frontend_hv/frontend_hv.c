/********************************************************************\
  ...
  $Id: frontend.c 3917 2007-09-15 03:30:07Z amaudruz $
...
char *frontend_name = "frontend_hv";
...
DEVICE_DRIVER hv_driver[] = {
   ...
   {"CAEN1527", caen1527, 180}, // this is what it should be
//   {"CAEN1527", caen1527, 80}, // this is for testing in our semi-broken state
   {""}
};
